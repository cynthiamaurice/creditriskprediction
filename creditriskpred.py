...
img = Image.open("C:\\Users\\personal\Desktop\\data_prediction_model\\logo.webp")
...
if st.button("Predict Loan Status"):
    if not check_income_loan_threshold(income, loan_amount):
        ...
        proba = model.predict_proba(input_data)[0][1]  # Probability of rejection
        threshold = 0.3
        predicted = 1 if proba > threshold else 0
        result = "✅ Approved" if predicted == 0 else "❌ Rejected"
